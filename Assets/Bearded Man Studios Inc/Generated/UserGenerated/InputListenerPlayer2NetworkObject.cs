...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class InputListenerPlayer2NetworkObject : NetworkObject
	{
		...
		public InputListenerPlayer2NetworkObject() : base() { Initialize(); }
		public InputListenerPlayer2NetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public InputListenerPlayer2NetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
