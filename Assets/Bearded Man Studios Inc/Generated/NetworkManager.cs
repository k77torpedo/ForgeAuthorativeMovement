...
namespace BeardedManStudios.Forge.Networking.Unity
{
	public partial class NetworkManager : MonoBehaviour
	{
		...
		public GameObject[] InputListenerPlayer2NetworkObject = null;
		public GameObject[] InputListenerPlayerNetworkObject = null;
		...
		private void CaptureObjects(NetworkObject obj)
		{
			...
			else if (obj is InputListenerPlayer2NetworkObject)
			{
				MainThreadManager.Run(() =>
				{
					NetworkBehavior newObj = null;
					if (!NetworkBehavior.skipAttachIds.TryGetValue(obj.NetworkId, out newObj))
					{
						if (InputListenerPlayer2NetworkObject.Length > 0 && InputListenerPlayer2NetworkObject[obj.CreateCode] != null)
						{
							var go = Instantiate(InputListenerPlayer2NetworkObject[obj.CreateCode]);
							newObj = go.GetComponent<InputListenerPlayer2Behavior>();
						}
					}
			...
			else if (obj is InputListenerPlayerNetworkObject)
			{
				MainThreadManager.Run(() =>
				{
					NetworkBehavior newObj = null;
					if (!NetworkBehavior.skipAttachIds.TryGetValue(obj.NetworkId, out newObj))
					{
						if (InputListenerPlayerNetworkObject.Length > 0 && InputListenerPlayerNetworkObject[obj.CreateCode] != null)
						{
							var go = Instantiate(InputListenerPlayerNetworkObject[obj.CreateCode]);
							newObj = go.GetComponent<InputListenerPlayerBehavior>();
						}
					}
		...
		[Obsolete("Use InstantiateInputListenerPlayer2 instead, its shorter and easier to type out ;)")]
		public InputListenerPlayer2Behavior InstantiateInputListenerPlayer2NetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(InputListenerPlayer2NetworkObject[index]);
			var netBehavior = go.GetComponent<InputListenerPlayer2Behavior>();
			var obj = netBehavior.CreateNetworkObject(Networker, index);
			go.GetComponent<InputListenerPlayer2Behavior>().networkObject = (InputListenerPlayer2NetworkObject)obj;

			FinalizeInitialization(go, netBehavior, obj, position, rotation, sendTransform);
			
			return netBehavior;
		}
		[Obsolete("Use InstantiateInputListenerPlayer instead, its shorter and easier to type out ;)")]
		public InputListenerPlayerBehavior InstantiateInputListenerPlayerNetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(InputListenerPlayerNetworkObject[index]);
			var netBehavior = go.GetComponent<InputListenerPlayerBehavior>();
			var obj = netBehavior.CreateNetworkObject(Networker, index);
			go.GetComponent<InputListenerPlayerBehavior>().networkObject = (InputListenerPlayerNetworkObject)obj;
		...
		/// <summary>
		/// Instantiate an instance of InputListenerPlayer2
		/// </summary>
		/// <returns>
		/// A local instance of InputListenerPlayer2Behavior
		/// </returns>
		/// <param name="index">The index of the InputListenerPlayer2 prefab in the NetworkManager to Instantiate</param>
		/// <param name="position">Optional parameter which defines the position of the created GameObject</param>
		/// <param name="rotation">Optional parameter which defines the rotation of the created GameObject</param>
		/// <param name="sendTransform">Optional Parameter to send transform data to other connected clients on Instantiation</param>
		public InputListenerPlayer2Behavior InstantiateInputListenerPlayer2(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(InputListenerPlayer2NetworkObject[index]);
			var netBehavior = go.GetComponent<InputListenerPlayer2Behavior>();
		...
		/// <summary>
		/// Instantiate an instance of InputListenerPlayer
		/// </summary>
		/// <returns>
		/// A local instance of InputListenerPlayerBehavior
		/// </returns>
		/// <param name="index">The index of the InputListenerPlayer prefab in the NetworkManager to Instantiate</param>
		/// <param name="position">Optional parameter which defines the position of the created GameObject</param>
		/// <param name="rotation">Optional parameter which defines the rotation of the created GameObject</param>
		/// <param name="sendTransform">Optional Parameter to send transform data to other connected clients on Instantiation</param>
		public InputListenerPlayerBehavior InstantiateInputListenerPlayer(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(InputListenerPlayerNetworkObject[index]);
			var netBehavior = go.GetComponent<InputListenerPlayerBehavior>();
